...
const GadgetMultiple=()=>{
return(
<div style={{marginTop:"100px"}}>
<h1 className='main-1'>Electronics Headphones</h1>
<p className='main-2'>841 products</p>
...
<div className="main">
    <div className="left-section">
        ...
        <div className='left-sec2'>
            ...
            <span style={{padding:"5px 10px",backgroundColor:"#F5F5F5",borderRadius:"20px",fontSize:"14px",color:"grey"}}>Health & Beauty</span>
        </div>
        <div className='left-sec2'>
            <p style={{marginBottom:"12px",fontWeight:600}}>Category</p>
            <span style={{padding:"5px 10px",backgroundColor:"#F5F5F5",borderRadius:"20px",fontSize:"14px",color:"grey"}}>Regular products<i class="fa-solid fa-xmark fa-lg" style={{marginLeft:"8px"}}></i></span>
        </div>
