...
const AccessoriesMultiple=()=>{
return(
<div style={{marginTop:"100px"}}>
<h1 className='main-1'>Backpacks for men</h1>
...
<div className="main">
    <div className="left-section">
        ...
        <div className='left-sec2'>
            ...
            <span style={{padding:"5px 10px",backgroundColor:"#F5F5F5",borderRadius:"20px",fontSize:"14px",color:"grey"}}>Accessories</span>
        </div>
        <div className='left-sec2'>
            <p style={{marginBottom:"12px",fontWeight:600}}>Category</p>
            <span style={{padding:"5px 10px",backgroundColor:"#F5F5F5",borderRadius:"20px",fontSize:"14px",color:"grey"}}>Men's Bags<i class="fa-solid fa-xmark fa-lg" style={{marginLeft:"8px"}}></i></span>
        </div>
...
export default AccessoriesMultiple